...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://linkedin.com/in/suraj-nate-50001a27b)
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=flat-square&logo=vercel&logoColor=white)](https://surajnate.github.io/surajnateportfolio/)
[![Email](https://img.shields.io/badge/Email-EA4335?style=flat-square&logo=gmail&logoColor=white)](mailto:surajnate29@gmail.com)
[![YouTube](https://img.shields.io/badge/YouTube-FF0000?style=flat-square&logo=youtube&logoColor=white)](https://youtube.com/@suraj_nate)
...
### 🔐 SecureCode AI Agent *(Hackathon)*
> AI agent for real-time detection & auto-fixing of code vulnerabilities (SQL Injection, XSS, Buffer Overflow)  
> 3-stage pipeline: automated scan → vulnerability fix → chat-based manual review  
> `Python` `Streamlit` `Gemini 1.5 Pro` `LangChain` `GitHub API`
...
### 📄 PDF Query Assistant
> Natural language interface for PDF documents with semantic search and real-time Q&A  
> `Python` `LangChain` `OpenAI` `Pinecone` `Firebase` `Streamlit`
...
- 🎓 **AI Agents with Model Context Protocol (MCP)** · Vanderbilt University · Coursera
- 🎓 **Agentic AI Engineering** · Edureka
- 🎓 **Retrieval Augmented Generation (RAG)** · DeepLearning.ai
- 🎓 **30 Days AI Masterclass** · NoviTech R&D
- 🎓 **Python for Data Science (IBM Badge)** · CognitiveClass.ai
...
![Suraj's GitHub Stats](https://github-readme-stats.vercel.app/api?username=SurajNate&theme=tokyonight&hide_border=true&include_all_commits=true&count_private=true)

![GitHub Streak](https://github-readme-streak-stats.herokuapp.com/?user=SurajNate&theme=tokyonight&hide_border=true)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=SurajNate&theme=tokyonight&hide_border=true&include_all_commits=true&count_private=true&layout=compact)
...
*"Build systems that think, automate the repetitive, and ship things that matter."*

![Profile Views](https://komarev.com/ghpvc/?username=SurajNate&color=0e75b6&style=flat-square&label=Profile+Views)
